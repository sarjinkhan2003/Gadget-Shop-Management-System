...
public class Buy extends JFrame implements ActionListener
{
    ...
    public Buy(Canvas canvas,Home home){
	...
	public Buy(Pencil pencil,Home home){
	 ...
	 public Buy(Paintings painting,Home home)
	{
		super(" Buy ");
	...
	public Buy(Tools tool,Home home)
	{
		super(" Buy ");
		this.tool = tool;
		this.home = home;
	...
	public Buy(Colours colour,Home home)
	{
		super(" Buy ");
		this.colour = colour;
		this.home=home;
	...
	public Buy(ArtPaper ap,Home home)
	{
		super(" Buy ");
		this.ap = ap;
		this.home = home;
