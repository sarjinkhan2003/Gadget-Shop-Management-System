...
public class Home extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==b2){
			...
			this.setVisible(false);
			new ArtPaper(this,login_obj);
		}
		else if(e.getSource() == colorButton)
		{
			this.setVisible(false);
			new Colours(this,login_obj);
		}
		else if(e.getSource() == pencilButton)
		{
			this.setVisible(false);
			new Pencil(this,login_obj);
		}
		else if(e.getSource() == canvasButton)
		{
			this.setVisible(false);
			new Canvas(this,login_obj);
		}
		else if(e.getSource() == paintingButton)
		{
			this.setVisible(false);
			new Paintings(this,login_obj);
		}
		else if(e.getSource() == toolButton)
		{
			this.setVisible(false);
			new Tools(this,login_obj);
		}
	}
}
